...
with open(r'C:\Users\User\OneDrive\Tài liệu\GitHub\12_Duc_17A2\BTVN_Chương_3\heights.txt', 'r', encoding='utf-8-sig') as f:
    read = f.readlines()
    heights = list(map(lambda x: float(x), read[0].split(',')))

with open(r'C:\Users\User\OneDrive\Tài liệu\GitHub\12_Duc_17A2\BTVN_Chương_3\positions.txt', 'r', encoding='utf-8-sig') as f:
    read = f.readlines()
